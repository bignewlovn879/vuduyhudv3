...
_G.AutoFarm = a
    ...
    while wait() do
        if _G.AutoFarm then
 				if game:GetService("Players").LocalPlayer.PlayerGui..Quest.Visible == false then
				StartMagnet = false
				CheckQuest()
			...
			elseif game:GetService("Players").LocalPlayer.PlayerGui..Quest.Visible == true then
				pcall(function()
					CheckQuest()
							...
							if b.Name == Mon and b:FindFirstChild("Humanoid") then
								if b.Humanoid.Health > 0 then
									repeat game:GetService("RunService").Heartbeat:wait()
										if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
											if string.find(game:GetService("Players").LocalPlayer.PlayerGui..Quest.Container.QuestTitle.Title.Text, NameMon) then
									...
									until not b.Parent or b.Humanoid.Health <= 0 or _G.AutoFarm == false or game.Players.LocalPlayer.PlayerGui..Quest.Visible == false or not game:GetService("Workspace").Enemies:FindFirstChild(b.Name)
                                end
                            end
                        end
											else	
  ...
  pcall(function()
   local b = game:GetService("Players").LocalPlayer.PlayerGui..Quest.Container.QuestTitle.Title.Text
   ...
   game:GetService'VirtualUser':CaptureController()
   game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
   until not _G.AutoFarmFruitMastery or b.Humanoid.Health <= 0 or not b.Parent or game:GetService("Players").LocalPlayer.PlayerGui..Quest.Visible == false
   else
    UseSkill = false
   StartMasteryFruitMagnet = false
   game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
